...
const User = /* GraphQL */ `
	...
	type User {
		...
		directMessageThreadsConnection(first: Amount = 15, after: String): UserDirectMessageThreadsConnection!
		threadConnection(first: Amount = 10, after: String, kind: ThreadConnectionType): UserThreadsConnection!
		everything(first: Amount = 10, after: String): EverythingThreadsConnection!
