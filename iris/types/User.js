...
const User = /* GraphQL */ `
    ...
    isPro: Boolean! @cost(complexity: 1)
		...
		directMessageThreadsConnection(first: PaginationAmount = 15, after: String): UserDirectMessageThreadsConnection! @cost(complexity: 1, multiplier: "first")
		threadConnection(first: PaginationAmount = 20, after: String, kind: ThreadConnectionType): UserThreadsConnection! @cost(complexity: 1, multiplier: "first")
    everything(first: PaginationAmount = 20, after: String): EverythingThreadsConnection! @cost(complexity: 1, multiplier: "first")
