...
export const Byline = styled(H4)`
	...
	border-bottom: 2px solid ${props => (props.active ? props.theme.brand.default : 'transparent')};
	margin-right: 16px;
	position: relative;
...
export const Submit = styled.input`
	background-color: ${props => (props.active ? props.theme.brand.default : props.theme.text.placeholder)};
  background-image: ${props => (props.active ? Gradient(props.theme.brand.alt, props.theme.brand.default) : props.theme.text.placeholder)};
  color: #fff;
  border-radius: 8px;
  padding: 0.5rem 1rem;
  font-size: 0.875rem;
