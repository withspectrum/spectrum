...
export const COMMUNITY_BRANDED_LOGIN_DISABLED = 'Community Branded Login Disabled';
export const COMMUNITY_BRANDED_LOGIN_DISABLED_FAILED = 'Community Branded Login Disabled Failed';

export const COMMUNITY_BRANDED_LOGIN_ENABLED = 'Community Branded Login Enabled';
export const COMMUNITY_BRANDED_LOGIN_ENABLED_FAILED = 'Community Branded Login Enabled Failed';
...
export const COMMUNITY_SLACK_TEAM_INVITES_SENT_FAILED = 'Community Slack Team Invites Sent Failed';
export const COMMUNITY_SLACK_TEAM_RESET = 'Community Slack Team Reset'
