...
type Queues = {
  ...
  stripeChargeEventQueue: BullQueue<{ record: Object }>,
  stripeCustomerEventQueue: BullQueue<{ record: Object }>,
  stripeSourceEventQueue: BullQueue<{ record: Object }>,
  stripeInvoiceEventQueue: BullQueue<{ record: Object }>,
  stripeSubscriptionEventQueue: BullQueue<{ record: Object }>,
...
exports.QUEUE_NAMES = {
  ...
  stripeChargeEventQueue: 'process stripe charge webhook event',
  stripeCustomerEventQueue: 'process stripe customer webhook event',
  stripeSubscriptionEventQueue: 'process stripe subscription webhook event',
  stripeInvoiceEventQueue: 'process stripe invoice webhook event',
  stripeSourceEventQueue: 'process stripe source webhook event',
