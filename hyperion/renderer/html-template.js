...
try {
  ...
  throw new Error(
    'It looks like you didn\'t run "yarn run dev:client" or "yarn run build:client" before starting hyperion. Please wait until either of them completes before starting hyperion.'
  );
}
