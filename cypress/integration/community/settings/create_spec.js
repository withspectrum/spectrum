...
describe('creating a public community', () => {
  ...
  it('should create a public community', () => {
    cy
      .get('[data-cy="create-community-form"]')
      .scrollIntoView()
      .should('be.visible');

    cy
      .get('[data-cy="community-name-input"]')
      .scrollIntoView()
      .should('be.visible')
      .click()
    ...
    cy
      .get('[data-cy="community-public-selector-input"]')
      .scrollIntoView()
      .should('be.visible')
      .should('be.checked');

    cy
      .get('[data-cy="community-coc-input-unchecked"]')
      .scrollIntoView()
      .should('be.visible')
      .click();

    cy
      .get('[data-cy="community-create-button"]')
      .scrollIntoView()
      .should('be.visible')
...
describe('creating a private community', () => {
  ...
  it('should create a private community', () => {
    ...
    cy
      .get('[data-cy="community-private-selector-input"]')
      .should('be.visible')
