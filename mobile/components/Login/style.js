...
export const TwitterButton = (props: any) => {
  ...
  return (
    <SigninButton color={theme.social.twitter.default}>
      <Container>
...
export const FacebookButton = (props: any) => {
  ...
  return (
    <SigninButton color={theme.social.facebook.default}>
      <Container>
...
export const GoogleButton = (props: any) => {
  ...
  return (
    <SigninButton color={theme.social.google.default}>
      <Container>
...
export const GithubButton = (props: any) => {
  ...
  return (
    <SigninButton color={theme.social.github.default}>
      <Container>
