...
export const trimHtml = (html, options) => {
  ...
  let limit = options.limit || 140,
    preserveTags = typeof options.preserveTags !== 'undefined'
      ? options.preserveTags
      : true,
    wordBreak = typeof options.wordBreak !== 'undefined'
      ? options.wordBreak
      : true,
    suffix = options.suffix || '...[see more]()',
  ...
  let sum = 0, row, cut, add, tagMatch, tagName, tagStack = [], more = false;
