      ...
      <Wrapper data-cy="privacy-page">
        ...
        <ContentContainer>
          ...
          <Section>
            ...
            <SectionDescription>
            We use your data to provide and improve the Service. By using the Service, you agree to the collection and use of information in accordance with this policy. Unless otherwise defined in this Privacy Policy, terms used in this Privacy Policy have the same meanings as in our Terms and Conditions, accessible from spectrum.chat.
            </SectionDescription>
          </Section>
          ...
          <Section>
            ...
            <SectionDescription>
              We store and process the information that we collect in the United States in accordance with this Privacy Policy (our subprocessors may store and process data outside the United States). For cross-border data transfers from the European Union (EU) and the European Economic Area (EEA), GitHub adheres to the Privacy Shield Framework. You may view our entry in the Privacy Shield List.
            </SectionDescription>
            ...
            <SectionDescription>
            We provide all of our users notice, choice, accountability, security, and access, and we limit the purpose for processing. We also provide our users a method of recourse and enforcement. These are the Privacy Shield Principles, but they are also just good practices. In addition, we participate in and comply with the Privacy Shield framework, and we are committed to subject any Personal Data we receive from the EU and EEA to the Privacy Shield Principles. Please read more about GitHub's international privacy commitments.
            </SectionDescription>
...
Please note that we may ask you to verify your identity before responding to such requests.
          ...
          <Section>
            ...
            <SectionDescription>
            Our Service does not address anyone under the age of 13 (“Children”). If you're a child under the age of 13, you may not have an account on Spectrum.
            </SectionDescription>
