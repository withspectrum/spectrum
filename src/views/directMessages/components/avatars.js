  ...
  if (users.length === 2) {
    return (
      <TwoAvatarContainer>
        {users.map(user => {
          return (
            <Avatar key={user.id} size={34} radius={34} src={user.photoURL} />
          );
        })}
      </TwoAvatarContainer>
    );
  ...
  if (users.length === 3) {
    return (
      <ThreeAvatarContainer>
        {users.map(user => {
          return (
            <Avatar key={user.id} size={20} radius={20} src={user.photoURL} />
          );
        })}
      </ThreeAvatarContainer>
    );
  ...
  if (users.length === 4) {
    return (
      <ThreeAvatarContainer>
        {users.map(user => {
          return (
            <Avatar key={user.id} size={19} radius={19} src={user.photoURL} />
          );
        })}
      </ThreeAvatarContainer>
    );
