...
*/
  ...
  /***/ './src/components/upsell/requestToJoinChannel.js':
    /*!*******************************************************!*\
  !*** ./src/components/upsell/requestToJoinChannel.js ***!
  \*******************************************************/
    /*! exports provided: default */
    ...
    /***/ function(module, __webpack_exports__, __webpack_require__) {
      ...
      /* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__buttons__ = __webpack_require__(
        /*! ../buttons */ './src/components/buttons/index.js'
      );
      /* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__style__ = __webpack_require__(
        /*! ./style */ './src/components/upsell/style.js'
      );
      var _jsxFileName =
        '/Users/brianlovin/Sites/spectrum/src/components/upsell/requestToJoinChannel.js';
      ...
      var RequestToJoinChannel = (function(_Component) {
        _inherits(RequestToJoinChannel, _Component);

        function RequestToJoinChannel() {
          _classCallCheck(this, RequestToJoinChannel);

          var _this = _possibleConstructorReturn(
            this,
            (
              RequestToJoinChannel.__proto__ ||
              Object.getPrototypeOf(RequestToJoinChannel)
            ).call(this)
          );

          _this.toggleRequest = function() {
            var _this$props = _this.props,
              toggleChannelSubscription = _this$props.toggleChannelSubscription,
              dispatch = _this$props.dispatch,
            ...
            toggleChannelSubscription({ channelId: channelId })
              .then(function(_ref) {
                var toggleChannelSubscription =
                  _ref.data.toggleChannelSubscription;
                ...
                if (isPending) {
                  ...
                  )('channel', 'requested to join', null);
                } else {
                  Object(
                    __WEBPACK_IMPORTED_MODULE_4__helpers_events__[
                      'b' /* track */
                    ]
                  )('channel', 'cancelled request to join', null);
                }
                ...
                var str = isPending
                  ? 'Requested to join ' +
                    ...
                    '!'
                  : 'Canceled request to join ' +
                    toggleChannelSubscription.name +
                    ' in ' +
                    toggleChannelSubscription.community.name +
                    '.';

                var type = isPending ? 'success' : 'neutral';
                dispatch(
                  Object(
        ...
        _createClass(RequestToJoinChannel, [
          {
            key: 'render',
            value: function render() {
              var _props = this.props,
              ...
              return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                __WEBPACK_IMPORTED_MODULE_8__style__['a' /* Actions */],
                {
                  __source: {
                    fileName: _jsxFileName,
                    lineNumber: 85,
                ...
                isPending &&
                  __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                    __WEBPACK_IMPORTED_MODULE_7__buttons__[
                      'e' /* OutlineButton */
                    ],
                    {
                      large: true,
                ...
                isPending &&
                  __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                    ...
                    __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                      __WEBPACK_IMPORTED_MODULE_7__buttons__['a' /* Button */],
                      {
                        large: true,
                        __source: {
                          fileName: _jsxFileName,
      ...
      /* harmony default export */ __webpack_exports__[
        ...
        __WEBPACK_IMPORTED_MODULE_5__api_channel__[
          'k' /* toggleChannelSubscriptionMutation */
        ]
  ...
  /***/ './src/views/channel/components/notificationsToggle.js':
    /*!*************************************************************!*\
  !*** ./src/views/channel/components/notificationsToggle.js ***!
  \*************************************************************/
    /*! exports provided: NotificationsToggle, default */
    /*! exports used: default */
    /***/ function(module, __webpack_exports__, __webpack_require__) {
      'use strict';
      /* unused harmony export NotificationsToggle */
      /* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_react__ = __webpack_require__(
        /*! react */ './node_modules/react/react.js'
      );
      /* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_react___default = __webpack_require__.n(
      ...
      /* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__api_channel__ = __webpack_require__(
        /*! ../../../api/channel */ './src/api/channel.js'
      );
      /* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__components_formElements__ = __webpack_require__(
        /*! ../../../components/formElements */ './src/components/formElements/index.js'
      );
      /* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__actions_toasts__ = __webpack_require__(
        /*! ../../../actions/toasts */ './src/actions/toasts.js'
      );
      /* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__components_listItems_style__ = __webpack_require__(
        /*! ../../../components/listItems/style */ './src/components/listItems/style.js'
      );
      var _jsxFileName =
        '/Users/brianlovin/Sites/spectrum/src/views/channel/components/notificationsToggle.js';
      ...
      var NotificationsTogglePure = (function(_React$Component) {
        _inherits(NotificationsTogglePure, _React$Component);

        function NotificationsTogglePure(props) {
          _classCallCheck(this, NotificationsTogglePure);

          var _this = _possibleConstructorReturn(
            this,
            (
              NotificationsTogglePure.__proto__ ||
              Object.getPrototypeOf(NotificationsTogglePure)
            ).call(this, props)
          );

          _initialiseProps.call(_this);

          var isReceiving = props.value;
          _this.state = {
        ...
        _createClass(NotificationsTogglePure, [
          {
            key: 'render',
            value: function render() {
              var isReceiving = this.state.isReceiving;
              var channel = this.props.channel;

              return __WEBPACK_IMPORTED_MODULE_0_react__['createElement'](
                __WEBPACK_IMPORTED_MODULE_6__components_listItems_style__[
                  'p' /* StyledCard */
                ],
                {
                  largeOnly: true,
                ...
                __WEBPACK_IMPORTED_MODULE_0_react__['createElement'](
                  ...
                  __WEBPACK_IMPORTED_MODULE_0_react__['createElement'](
                    __WEBPACK_IMPORTED_MODULE_4__components_formElements__[
                      'a' /* Checkbox */
                    ],
                    {
                      id: 'isPrivate',
                    ...
                    'Get notified when new threads are published in ',
                    channel.name
                  )
                )
              );
        ...
        return NotificationsTogglePure;
      })(__WEBPACK_IMPORTED_MODULE_0_react__['Component']);
      ...
      var _initialiseProps = function _initialiseProps() {
        ...
        this.handleChange = function() {
          var id = _this2.props.channel.id;
          var isReceiving = _this2.state.isReceiving;
          ...
          _this2.props
            ...
            .then(function(_ref) {
              var toggleChannelNotifications =
                _ref.data.toggleChannelNotifications;

              var value =
                toggleChannelNotifications.channelPermissions
                  .receiveNotifications;
              var type = value ? 'success' : 'neutral';
              var str = value
                ? 'Notifications activated!'
                : 'Notifications turned off.';
              _this2.props.dispatch(
                Object(
                  __WEBPACK_IMPORTED_MODULE_5__actions_toasts__[
                    'a' /* addToastWithTimeout */
                  ]
                )(type, str)
              );
      ...
      var NotificationsToggle = __WEBPACK_IMPORTED_MODULE_1_recompose_compose___default()(
        __WEBPACK_IMPORTED_MODULE_3__api_channel__[
          'j' /* toggleChannelNotificationsMutation */
        ],
        Object(__WEBPACK_IMPORTED_MODULE_2_react_redux__['a' /* connect */])()
  ...
  !*** ./src/views/channel/components/pendingUsersNotification.js ***!
  \******************************************************************/
    /*! exports provided: PendingUsersNotification, default */
    /*! exports used: default */
    /***/ function(module, __webpack_exports__, __webpack_require__) {
      'use strict';
      /* unused harmony export PendingUsersNotification */
      /* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_react__ = __webpack_require__(
        /*! react */ './node_modules/react/react.js'
      );
      /* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_react___default = __webpack_require__.n(
      ...
      /* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__style__ = __webpack_require__(
        /*! ./style */ './src/views/channel/components/style.js'
      );
      var _jsxFileName =
          '/Users/brianlovin/Sites/spectrum/src/views/channel/components/pendingUsersNotification.js',
        _this = this;
      ...
      var PendingUsersNotificationPure = function PendingUsersNotificationPure(
        _ref
      ) {
        var channel = _ref.data.channel;

        if (
          !channel ||
          !channel.pendingUsers ||
        ...
        return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
          __WEBPACK_IMPORTED_MODULE_5__style__[
            'b' /* PendingUserNotificationContainer */
          ],
          {
            __source: {
              fileName: _jsxFileName,
          ...
          __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
            ...
            {
              to:
                '/' + channel.community.slug + '/' + channel.slug + '/settings',
              __source: {
                fileName: _jsxFileName,
                lineNumber: 17,
              },
            ...
            __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
              __WEBPACK_IMPORTED_MODULE_5__style__['a' /* PendingUserCount */],
              {
                __source: {
                  fileName: _jsxFileName,
                  lineNumber: 18,
      ...
      var PendingUsersNotification = __WEBPACK_IMPORTED_MODULE_2_recompose_compose___default()(
  ...
  /***/ './src/views/channel/components/style.js':
    /*!***********************************************!*\
  !*** ./src/views/channel/components/style.js ***!
  \***********************************************/
    /*! exports provided: PendingUserNotificationContainer, PendingUserCount */
    /*! exports used: PendingUserCount, PendingUserNotificationContainer */
    /***/ function(module, __webpack_exports__, __webpack_require__) {
      'use strict';
      /* harmony export (binding) */ __webpack_require__.d(
        __webpack_exports__,
        'b',
        function() {
          return PendingUserNotificationContainer;
        }
      );
      /* harmony export (binding) */ __webpack_require__.d(
        __webpack_exports__,
      ...
      var PendingUserNotificationContainer = Object(
        __WEBPACK_IMPORTED_MODULE_0_styled_components__['c' /* default */]
      )(
        __WEBPACK_IMPORTED_MODULE_1__components_card__['a' /* Card */]
      ).withConfig({
        displayName: 'style__PendingUserNotificationContainer',
        componentId: 's1fhweq6-0',
      })(
        [
          'width:100%;margin-top:16px;display:flex;align-items:center;flex:1;font-size:14px;font-weight:600;color:',
          ';a{padding:16px;}',
        ],
        function(props) {
          return props.theme.text.alt;
      ...
      var PendingUserCount = __WEBPACK_IMPORTED_MODULE_0_styled_components__[
        'c' /* default */
      ].span.withConfig({
        displayName: 'style__PendingUserCount',
        componentId: 's1fhweq6-1',
      })(
        [
          'padding:4px 8px;border-radius:8px;color:#fff;font-size:14px;font-weight:700;margin-right:12px;background:',
          ';',
        ],
        function(props) {
  ...
  \************************************/
    ...
    /***/ function(module, __webpack_exports__, __webpack_require__) {
      ...
      /* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__actions_newUserOnboarding__ = __webpack_require__(
      ...
      /* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__components_column__ = __webpack_require__(
        /*! ../../components/column */ './src/components/column/index.js'
      );
      /* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__components_threadFeed__ = __webpack_require__(
        /*! ../../components/threadFeed */ './src/components/threadFeed/index.js'
      );
      /* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__components_profile__ = __webpack_require__(
        /*! ../../components/profile */ './src/components/profile/index.js'
      );
      /* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__components_pendingUsersNotification__ = __webpack_require__(
        /*! ./components/pendingUsersNotification */ './src/views/channel/components/pendingUsersNotification.js'
      );
      /* harmony import */ var __WEBPACK_IMPORTED_MODULE_14__components_notificationsToggle__ = __webpack_require__(
        /*! ./components/notificationsToggle */ './src/views/channel/components/notificationsToggle.js'
      );
      /* harmony import */ var __WEBPACK_IMPORTED_MODULE_15__queries__ = __webpack_require__(
        /*! ./queries */ './src/views/channel/queries.js'
      );
      /* harmony import */ var __WEBPACK_IMPORTED_MODULE_16__login__ = __webpack_require__(
        /*! ../login */ './src/views/login/index.js'
      );
      /* harmony import */ var __WEBPACK_IMPORTED_MODULE_17__components_loading__ = __webpack_require__(
        /*! ../../components/loading */ './src/components/loading/index.js'
      );
      /* harmony import */ var __WEBPACK_IMPORTED_MODULE_18__components_upsell__ = __webpack_require__(
        /*! ../../components/upsell */ './src/components/upsell/index.js'
      );
      /* harmony import */ var __WEBPACK_IMPORTED_MODULE_19__components_upsell_requestToJoinChannel__ = __webpack_require__(
        /*! ../../components/upsell/requestToJoinChannel */ './src/components/upsell/requestToJoinChannel.js'
      );
      /* harmony import */ var __WEBPACK_IMPORTED_MODULE_20__communitySettings_components_upgradeCommunity__ = __webpack_require__(
        /*! ../communitySettings/components/upgradeCommunity */ './src/views/communitySettings/components/upgradeCommunity.js'
      );
      /* harmony import */ var __WEBPACK_IMPORTED_MODULE_21__titlebar__ = __webpack_require__(
        /*! ../titlebar */ './src/views/titlebar/index.js'
      );
      var _jsxFileName =
        '/Users/brianlovin/Sites/spectrum/src/views/channel/index.js';
      ...
      var ThreadFeedWithData = __WEBPACK_IMPORTED_MODULE_1_recompose_compose___default()(
        Object(__WEBPACK_IMPORTED_MODULE_2_react_redux__['a' /* connect */])(),
        __WEBPACK_IMPORTED_MODULE_15__queries__['b' /* getChannelThreads */]
      )(
        __WEBPACK_IMPORTED_MODULE_11__components_threadFeed__['a' /* default */]
      );

      var ChannelView = (function(_React$Component) {
        _inherits(ChannelView, _React$Component);
        ...
        function ChannelView() {
          ...
          return _possibleConstructorReturn(
            this,
            (ChannelView.__proto__ || Object.getPrototypeOf(ChannelView)).apply(
              this,
              arguments
            )
          );
        ...
        _createClass(ChannelView, [
          {
            ...
            value: function componentDidUpdate(prevProps) {
              ...
              if (
                ...
                this.props.dispatch(
                  Object(
                    __WEBPACK_IMPORTED_MODULE_4__actions_newUserOnboarding__[
            ...
            value: function render() {
              ...
              if (channel) {
                ...
                var _channel$channelPermi = channel.channelPermissions,
                  isBlocked = _channel$channelPermi.isBlocked,
                  isPending = _channel$channelPermi.isPending,
                  isMember = _channel$channelPermi.isMember,
                ...
                var isRestricted = channel.isPrivate && !userHasPermissions;
                var isGlobalOwner =
                ...
                if (!isLoggedIn && channel.isPrivate) {
                  return __WEBPACK_IMPORTED_MODULE_0_react__['createElement'](
                    __WEBPACK_IMPORTED_MODULE_16__login__['b' /* default */],
                    {
                ...
                if (isBlocked) {
                  return __WEBPACK_IMPORTED_MODULE_0_react__['createElement'](
                    ...
                    __WEBPACK_IMPORTED_MODULE_0_react__['createElement'](
                      __WEBPACK_IMPORTED_MODULE_21__titlebar__[
                        'a' /* default */
                      ],
                      {
                    ...
                    __WEBPACK_IMPORTED_MODULE_0_react__['createElement'](
                      ...
                      __WEBPACK_IMPORTED_MODULE_0_react__['createElement'](
                        __WEBPACK_IMPORTED_MODULE_18__components_upsell__[
                          'c' /* Upsell404Channel */
                        ],
                        {
                ...
                if (isRestricted) {
                  return __WEBPACK_IMPORTED_MODULE_0_react__['createElement'](
                    ...
                    __WEBPACK_IMPORTED_MODULE_0_react__['createElement'](
                      ...
                      __WEBPACK_IMPORTED_MODULE_0_react__['createElement'](
                        __WEBPACK_IMPORTED_MODULE_19__components_upsell_requestToJoinChannel__[
                          'a' /* default */
                        ],
                        {
                          channel: channel,
                ...
                return __WEBPACK_IMPORTED_MODULE_0_react__['createElement'](
                  ...
                  __WEBPACK_IMPORTED_MODULE_0_react__['createElement'](
                    __WEBPACK_IMPORTED_MODULE_21__titlebar__['a' /* default */],
                    {
                      title: channel.name,
                      subtitle: channel.community.name,
                      provideBack: true,
                  ...
                  __WEBPACK_IMPORTED_MODULE_0_react__['createElement'](
                    __WEBPACK_IMPORTED_MODULE_10__components_column__[
                      'b' /* default */
                    ],
                    {
                      type: 'secondary',
                    ...
                    __WEBPACK_IMPORTED_MODULE_0_react__['createElement'](
                      __WEBPACK_IMPORTED_MODULE_12__components_profile__[
                        'a' /* ChannelProfile */
                      ],
                      {
                    ...
                    isLoggedIn &&
                      userHasPermissions &&
                      __WEBPACK_IMPORTED_MODULE_0_react__['createElement'](
                        __WEBPACK_IMPORTED_MODULE_14__components_notificationsToggle__[
                          'a' /* default */
                        ],
                        {
                          value:
                    ...
                    isLoggedIn &&
                      ...
                      __WEBPACK_IMPORTED_MODULE_0_react__['createElement'](
                        __WEBPACK_IMPORTED_MODULE_13__components_pendingUsersNotification__[
                          'a' /* default */
                        ],
                        {
                          channel: channel,
                  ...
                  __WEBPACK_IMPORTED_MODULE_0_react__['createElement'](
                    ...
                    !isLoggedIn &&
                      __WEBPACK_IMPORTED_MODULE_0_react__['createElement'](
                        ...
                        {
                          title:
                            'Join the ' + channel.community.name + ' community',
                    ...
                    isLoggedIn &&
                      ...
                      __WEBPACK_IMPORTED_MODULE_0_react__['createElement'](
                        __WEBPACK_IMPORTED_MODULE_20__communitySettings_components_upgradeCommunity__[
                          'b' /* UpsellUpgradeCommunityPrivateChannel */
                        ],
                        {
                          community: channel.community,
                          __source: {
              ...
              if (isLoading) {
                return __WEBPACK_IMPORTED_MODULE_0_react__['createElement'](
                  __WEBPACK_IMPORTED_MODULE_17__components_loading__[
                    'l' /* LoadingScreen */
                  ],
                  {
                    __source: {
      ...
      /* harmony default export */ __webpack_exports__[
        ...
        __WEBPACK_IMPORTED_MODULE_15__queries__['a' /* getChannel */],
...
//# sourceMappingURL=ChannelView.chunk.js.map
